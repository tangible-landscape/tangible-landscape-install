...
# Ubuntu 24.04 with Azure Kinect (k4a)
#
# This script installs:
# - GRASS (compiled from source)
# - PCL (Point Cloud Library)
# - Azure Kinect SDK (k4a)
# - r.in.kinect GRASS tool (pcl-k4a branch)
...
echo "Ubuntu 24.04 + Azure Kinect (k4a)"
echo "=============================================="
...
# ============================================
# r.in.kinect (GRASS tool for Azure Kinect)
# ============================================
echo ""
echo "Installing r.in.kinect (k4a branch)..."

if [ ! -d "r.in.kinect" ]; then
    git clone --branch k4a https://github.com/tangible-landscape/r.in.kinect
else
    cd r.in.kinect
    git fetch
    git checkout k4a
...
echo ""
echo "To test the Azure Kinect sensor:"
echo "  - Run: k4aviewer"
echo "  - Or run: lsusb | grep -i microsoft"
echo ""
echo "To start GRASS:"
echo "  - Run: grass"
